  ...
  <layout :disable-layout="true">
    ...
    <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
      ...
      <div class="d-flex flex-center mb-3">
        <img :src="require(`src/assets/logo-square${$store.state.settings.dark?'-inv':''}.png`).default" class="logo" :alt="name">
      </div>
      ...
      <div>
        ...
        <div class="pt-3 d-flex justify-content-center">
          <loading-button ref="refLoadingButton" text="Login" :submit="handleLogin" icon="fas fa-sign-in-alt"
